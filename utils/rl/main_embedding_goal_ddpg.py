...
def run(args):
    ...
    save_dir = "result/goal_model/kl_0.5/1.0/0526"

    save_dir = os.path.join(save_dir, "{}".format(str(68)))
    ...
    title2 = "Reward_100_ddpg_goal_embedding_nopre_"
    title3 = "Test_Reward_100_ddpg_goal_embedding_nopre_"
    title4 = "Test_epioside_step_100_ddpg_goal_embedding_nopre_"
    title5 = "Test_success_rate_100_ddpg_goal_embedding_nopre_"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", default='Goal-make')  # platform goal HFO
    ...
    parser.add_argument("--actor_lr", default=1e-5, type=int)
    parser.add_argument("--critic_lr", default=1e-3, type=int)
    parser.add_argument("--tau_actor", default=0.0001, type=int)
    parser.add_argument("--tau_critic", default=0.001, type=int)
